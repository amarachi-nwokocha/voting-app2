...
import { UserPlus, Vote, Trophy, PersonStanding } from "lucide-react"; // Import icons
  ...
  return (
    <main className="min-h-screen bg-black text-[#db8f2c] flex flex-col items-center justify-center px-6 py-12">
       <Image
          ...
          />
      <h1 className="text-4xl font-bold mb-10">PHAROAH&apos;S <span className="text-white">HOUNDS</span> HUB</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-5xl">
        {cards.map(({ title, description, href, icon: Icon }) => (
          ...
          >
            <Icon className="w-12 h-12 mb-4 text-[#db8f2c] " /> {/* Icon */}
